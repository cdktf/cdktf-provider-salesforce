...
export class SalesforceProvider extends cdktf.TerraformProvider {
  ...
  * @param importToId The construct id used in the generated config for the SalesforceProvider to import
  * @param importFromId The id of the existing SalesforceProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/salesforce/0.1.0/docs#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the SalesforceProvider to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "salesforce", importId: importFromId, provider });
      }
